...
export function StreakDisplay({ compact = false }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-purple-100 dark:border-purple-800"
    >
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Your Progress</h3>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{streakData.currentStreak}</p>
        ...
        <div className="text-center">
          ...
          <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{streakData.totalPoints || 0}</p>
        ...
        <div className="text-center">
          ...
          <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{streakData.longestStreak}</p>
          <p className="text-xs text-gray-600 dark:text-gray-300">Best Streak</p>
        </div>
      </div>
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-3 gap-2 text-center">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">Hints</p>
          </div>
          <div>
            <p className="text-sm font-semibold text-purple-600">{streakData.titles?.length || 0}</p>
            <p className="text-xs text-gray-600 dark:text-gray-300">Titles</p>
          </div>
        </div>
      </div>
      ...
      {streakData.currentTitle && (
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="text-center">
            <p className="text-xs text-gray-600 dark:text-gray-300 mb-1">Current Title</p>
